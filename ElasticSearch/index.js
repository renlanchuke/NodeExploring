...
var query = {
  'bool':
  {
    ...
    'must_not': [{ 'range': { 'IPV4_DST_ADDR': { 'gte': '0.0.0.0', 'lt': '0.255.255.255' } } },
                 ...
                 { 'range': { 'IPV4_DST_ADDR': {
                   'gte': '169.254.0.0', 'lt': '169.254.255.255' } } },
                 { 'range': { 'IPV4_SRC_ADDR': {
                   'gte': '169.254.0.0', 'lt': '169.254.255.255' } } },
                 ...
                 { 'range': { 'IPV4_DST_ADDR': {
                   'gte': '255.255.255.255', 'lt': '255.255.255.255' } } },
...
var agg = {
  'assets_dst': {
    'terms': {
      'script': "doc['NTOPNG_INSTANCE_NAME.raw'].value + '|' + doc['INTERFACE.raw'].value + '|' " +
      "+ doc['IPV4_DST_ADDR.raw'].value + '|' + doc['OUT_DST_MAC.raw'].value"
    },
    'aggs': {
      'first_seen': {
        'top_hits': {
  ...
  'assets_src': {
    'terms': {
      ...
      "+ doc['INTERFACE.raw'].value + '|' + doc['IPV4_SRC_ADDR.raw'].value + " +
      "'|' + doc['IN_SRC_MAC.raw'].value"
    },
    'aggs': {
      'first_seen': {
        'top_hits': {
